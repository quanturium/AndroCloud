...
public interface CloudAppItem
{
	...
	enum Type
	{
		AUDIO, BOOKMARK, IMAGE, UNKNOWN, VIDEO, ARCHIVE, TEXT;
	}

	/**
	 * @return A unique URL that points to this resource. ie: "http://my.cl.ly/items/1912729"
	...
	void setName(String value) throws CloudAppException;
	...
	/**
	 * @return The url to the actual content of this resource. ie: "http://cl.ly/2wr4/CloudApp_Logo.png"
	 * @throws CloudAppExtion
	 */
	...
	/**
	 * @return A url that points to the icon of this resource's type. ie: "http://my.cl.ly/images/new/item-types/image.png"
	 * @throws CloudAppExtion
	 */
	String getIconUrl() throws CloudAppException;

	/**
	 * @return A url that you can use to publicly point to this url. ie: "http://f.cl.ly/items/7c7aea1395c3db0aee18/CloudApp%20Logo.png"
	 * @throws CloudAppExtion
	 */
	...
	/**
	 * @return Identifies the app that uploaded this item. ie: "Cloud/1.5.1 CFNetwork/520.0.13 Darwin/11.0.0 (x86_64) (MacBookPro5%2C5)"
	 * @throws CloudAppExtion
	 */
	...
	JSONObject toJson() throws JSONException, CloudAppException;
